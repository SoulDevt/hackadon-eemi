...
<body>
    <div class="container-fluid"
        style="background-image: url(images/bg-vert.png);height: 800px;background-size: 100%;background-repeat: no-repeat;">
        <header>
        ...
        <div class="corps text-center" style="padding-top: 50%">
            <div>
                ...
                <p style="font-family: 'Lato', sans-serif; color:white;">WHAT DID YOU EAT FOR YOUR LAST MEAL ?</p>
                ...
                <form action="nutrition1.php" method="POST">
                    <div class="center-align" style="left: 65%;">

                        <input type="radio" name="choice" id="size_1" value="1" />
                        <label for="size_1">I had a competitive, well-balanced meal</label>

                        <input type="radio" name="choice" id="size_2" value="2" />
                        <label for="size_2">I made myself a treat</label>

                        <input type="radio" name="choice" id="size_3" value="3" />
                        <label for="size_3">I've been deprived of meals( or nibbling )</label>
                        <div style="padding-top: 25%; padding-left: 64%;">
                ...
                <?php
                    if(isset($_POST["choice"])) {
                        $_SESSION['reponse-nutri1'] = $_POST["choice"];
                        echo "<p>".$_SESSION['reponse-nutri1']."</p>";
                        header('Location: nutrition2.php');
                    }
                ?>
                <!-- <div>
