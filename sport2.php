    ...
    <div class="container-fluid"
        ...
        <div class="corps text-center" style="padding-top: 50%">
            <div>
                ...
                <p style="font-family: 'Lato', sans-serif; color:white;">IS IT: </p>
                ...
                <form action="sport2.php" method="POST">
                    <div class="center-align">

                        <input type="radio" name="choice" id="size_1" value="1" />
                        <label for="size_1">Exceptional</label>
                ...
                <?php
                    if(isset($_POST["choice"])) {
                        $_SESSION['reponse-nutri3'] = $_POST["choice"];
                        echo "<p>".$_SESSION['reponse-sport2']."</p>";
                        header('Location: sleep1.php');
                    }
                ?>
                <!-- <div>
