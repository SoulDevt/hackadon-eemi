    ...
    <div class="container-fluid"
        ...
        <div class="corps text-center" style="padding-top: 50%">
            <div>
                ...
                <p style="font-family: 'Lato', sans-serif; color:white;">DO YOU TAKE TIME TO PREPARE YOUR OWN MEAL ?</p>
                ...
                <?php
                    if(isset($_POST["choice"])) {
                        $_SESSION['reponse-nutri2'] = $_POST["choice"];
